...
const PayrollCalculatorForm = ({ children }) => {
    ...
    return (
        <form class="max-w-sm mx-auto" >
            ...
            <PayrollInput label="Yearly Pay" id="yearlyPay" initialValue={yearlyPay} onChange={(newValue) => updatePayroll('yearly', newValue)} />
            <PayrollInput label="Monthly Pay" id="monthlyPay" initialValue={monthlyPay} onChange={(newValue) => updatePayroll('monthly', newValue)} />
            <PayrollInput label="Weekly Pay" id="weeklyPay" initialValue={weeklyPay} onChange={(newValue) => updatePayroll('weekly', newValue)} />
            <PayrollInput label="Daily Pay" id="dailyPay" initialValue={dailyPay} onChange={(newValue) => updatePayroll('daily', newValue)} />
            <PayrollInput label="Hourly Pay" id="hourlyPay" initialValue={hourlyPay} onChange={(newValue) => updatePayroll('hourly', newValue)} />
            <PayrollInput label="Hours Worked" id="hoursWorked" initialValue={hoursWorked} onChange={(newValue) => updatePayroll('hoursWorked', newValue)} />
